[![Python • SQL• React • TypeScript](https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=666666&width=435&lines=Python+%E2%80%A2+SQL%E2%80%A2+React+%E2%80%A2+TypeScript)](https://git.io/typing-svg)

## 📝 О себе:


В сфере разработки с 2007 года.
...
<br/>
GitHub: 2019 - 2021 &nbsp;&nbsp; ➡ &nbsp;&nbsp; GitLab: 2022 - 2026 &nbsp;&nbsp; ➡ &nbsp;&nbsp; GitHub: 2026 &nbsp;&nbsp; ➡ &nbsp;&nbsp; Настоящее время 
<br/>
...
**Ташкентский Институт Инженеров Транспорта**<br/>
Специальность: Телекоммуникация <br/>
Годы обучения: 1999 - 2003
...
- React + TypeScript в крупных проектах


-------


## 💻 Персональный некоммерческий проект:

### LOKKER: 

Десктопный мультипользовательский менеджер паролей, разработанный на Python, PySide6, SQLite, Pytest.

Криптография реализована при помощи библиотеки **[cryptography](https://cryptography.io/)**


Приложение переведено на четыре языка (русский, английский, испанский, немецкий)

<br/>

#### Кратко:

- 🔑 PBKDF2 хеширование мастер-пароля
- 🔒 Надежное шифрование каждого пароля
- 👨‍👩‍👦 Регистрация неограниченного количества пользователей
- 🌎 Локализовано на 4 языка (ru, en, es, de)
- 🧰 Генератор безопасных паролей, добавление и удаление новых категорий, быстрый поиск сохраненных записей
- 📦 Инсталлер для Windows (доступно на странице презентации приложения)

<br/>

#### Технологии:
![Python](https://img.shields.io/badge/Python-3776AB?style=flat&logo=python&logoColor=white)
![PySide6](https://img.shields.io/badge/PySide6-000000?style=flat)
